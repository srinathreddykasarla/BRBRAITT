<?php
    ...
    <table width="100%" height="492" border="0" cellpadding="0" cellspacing="0"align="center">
    <tr>
   ...
   <!-- <form id="button1" name="form1" method="post" action="">
    ...
    <td align="right"><a href="register.php?key=BSNL1">Register</a></td>
    </tr>
    <tr>
    
    <td height="98"><font  style="animation:infinite" face="Times New Roman, Times, serif" text-align:"justify"; size="5" align="justify">Description:
    <font  style="animation:infinite" face="Times New Roman, Times, serif" text-align:"justify"; size="3" align="justify">'.$description[0].'</td>
    ...
    ';
        ...
        else
        {
            ...
            <td><font  style="animation:infinite" face="Times New Roman, Times, serif" text-align:center; size="5"> Starts On :
            <font  style="animation:infinite" face="Times New Roman, Times, serif" text-align:center; size="5">'.$date[0].'</td>
            <td align="right"><font  style="animation:infinite" face="Times New Roman, Times, serif" text-align:center; size="+2" color="red"><a href="register.php?key=BSNL1">Register</a></td>
            </tr>
            <tr>
